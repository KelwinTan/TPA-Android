...
public class MyReportCompletedAdapter extends RecyclerView.Adapter<MyReportCompletedAdapter.ViewHolder>{

    private Context context;
    private ArrayList<Report> reports;

    public MyReportCompletedAdapter(Context context) {
    ...
    public ViewHolder onCreateViewHolder(@NonNull ViewGroup viewGroup, int viewType) {
        ...
        return new MyReportCompletedAdapter.ViewHolder(view);
    }
