...
public class MyReportWaitingAdapter extends RecyclerView.Adapter<MyReportWaitingAdapter.ViewHolder> {

    private Context context;
    private ArrayList<Report> reports;

    public MyReportWaitingAdapter(Context context) {
    ...
    public ViewHolder onCreateViewHolder(@NonNull ViewGroup viewGroup, int viewType) {
        ...
        return new MyReportWaitingAdapter.ViewHolder(view);
    }
