...
public class MyReportLockedAdapter extends RecyclerView.Adapter<MyReportLockedAdapter.ViewHolder> {

    private Context context;
    private ArrayList<Report> reports;

    public MyReportLockedAdapter(Context context) {
    ...
    public ViewHolder onCreateViewHolder(@NonNull ViewGroup viewGroup, int viewType) {
        ...
        return new MyReportLockedAdapter.ViewHolder(view);
    }
